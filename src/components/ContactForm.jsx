...
import { submitContact } from '../api/wordpress';
...
${result.message}`);
      ...
      alert(`❌ Error: ${error.message}\n\nPlease try again or email us directly at info@floralkingdomtours.com`);
    } finally {
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="space-y-1 text-sm text-gray-600">
              <p>📧 Email: info@floralkingdomtours.com</p>
              <p>📞 Phone: +27 (0)21 123-4567</p>
              <p>🕒 Hours: Monday - Sunday, 8:00 AM - 6:00 PM</p>
            </div>
          </div>
